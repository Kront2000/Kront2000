...
<p align="left">Я студент 2-го курса, активно развиваюсь в современной веб-разработке. Разрабатываю fullstack-приложения на базе Next.js (App Router).  
Фокус — архитектура, типобезопасность и production-подход к разработке.</p>


###
<h3 align="left">⚙️ Основной стек</h3>
<div align="left">  
